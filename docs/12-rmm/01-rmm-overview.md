---
title: "RMM Overview and Features"
section: "RMM"
subsection: "Overview"
...
RMM is a collection of features that provide an advanced level of monitoring and management for endpoints and Microsoft 365 seats. You can learn more, try, or request a demo from Acronis.

## Features for Endpoints

Acronis RMM provides the following features for endpoints:
...
- **Vulnerability assessment for third-party Windows applications**: Enhance the security posture for Windows third-party applications by detecting and managing vulnerabilities across 314 critical applications, supported by an Acronis internally maintained database.
...
## Features for Microsoft 365 Seats

For Microsoft 365 seats, Acronis RMM provides a continuous audit of the Microsoft 365 security posture with best practice baselines, automatic remediation of security posture baseline deviations, and user onboarding and offboarding.
