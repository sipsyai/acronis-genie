...
source: "https://developer.acronis.com/doc/outbound/scenarios/psa/ticket-alert-sync/ticket-mapping.html"
source_domain: "developer"
scraped_at: "2026-03-22T02:31:53.531107"
---
...
The MSP wants to see existing mapping between Acronis alerts and PSA tickets.
...
Acronis alert.
PSA type.
PSA category (if available).
PSA status (if available).
PSA SLA (if available).
PSA priority (if available).
