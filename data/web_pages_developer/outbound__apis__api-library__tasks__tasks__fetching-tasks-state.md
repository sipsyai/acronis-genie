---
title: "Fetching a list of tasks that are in progress"
source: "https://developer.acronis.com/doc/outbound/apis/api-library/tasks/tasks/fetching-tasks-state.html"
source_domain: "developer"
scraped_at: "2026-03-22T02:27:15.834385"
---
...
To fetch a list of tasks that are in progress
...
Define a variable named filters, and then assign an object with the state key containing an array of task execution states to this variable:
>>> filters = {
...
Note
For the list of available task execution states, see the Task Manager API reference.
