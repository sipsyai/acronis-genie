...
source: "https://developer.acronis.com/doc/cyberapps/versions/customer-enablement/create-example-connection-setup-form.html"
source_domain: "developer"
scraped_at: "2026-03-22T02:01:24.840383"
---

# Building the example

Building the example
The example customer enablement form looks like this:


To build the example customer enablement form

Open the Version.
Select Customer enablement form from the menu.
...
When a customer enables the CyberApp, the callback requests will include X-CyberApp-Auth header in the following format:
