---
title: "Fetch customer support groups"
source: "https://developer.acronis.com/doc/outbound/apis/api-library/psa/managing-service-desk/fetch-ticket-support-groups.html"
source_domain: "developer"
scraped_at: "2026-03-22T02:25:05.284428"
---
...
Fetch the customer ID by following the Fetch a list of customers procedure.
As a result, you should have a customer ID that you will use in the following steps:
>>> customer_id
'ce570f06-f444-426b-b9b0-3aa8ef9b951e'
...
>>> response = requests.get(f'{base_url}/Group', headers=auth, params=params)
