...
Understanding your current level of protection > Monitoring > Disk health monitoring
Disk health monitoring
...
The protection agent collects the SMART parameters of the disks and passes this data to the Disk Health Prediction Service:
...
The Monitoring Service receives these characteristics, and then shows the relevant information in the disk health widgets in the Cyber Protect console.
