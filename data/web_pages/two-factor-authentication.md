...
Getting started with Cyber Protection > Activating the account > Two-factor authentication
Two-factor authentication
...
Install an authenticator app on your second-factor device.
...
Scan the QR code using your authenticator app, and then enter the 6-digit code displayed on the authenticator app in the Set up two-factor authentication window.
...
Return to the Cyber Protect console login page and enter the generated code.
...
Use the PDF file that you saved when you configured 2FA on your device.
...
Click Reset 2FA, and then enter the one-time password shown in the mobile authenticator app.
