...
RMM > Monitoring the health and performance of workloads > Configurable monitors > Settings of the CPU usage monitor
Settings of the CPU usage monitor
...
Anomaly duration	The system will generate an alert for a detected anomaly only if the abnormal behavior persists for the specified period.
