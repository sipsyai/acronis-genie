...
Managing the backup and recovery of workloads and files > Protecting Google Workspace data > Protecting Shared drive files > Recovering Shared drive files
Recovering Shared drive files
...
In Path, view or change the target folder in the target Shared drive or the target user's Google Drive. By default, the original location is selected.
