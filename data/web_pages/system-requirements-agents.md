...
Installing and deploying Cyber Protection agents > Before you start > System requirements for agents
System requirements for agents
...
The RAM usage might increase when backing up to extra large backup archives (4 TB and more).
...
Features	Device Control	Data Loss Prevention (DLP)
Local channels
