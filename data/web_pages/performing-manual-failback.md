...
Implementing disaster recovery > Disaster Recovery to Cyber Protect Cloud > Failback > Performing manual failback
Performing manual failback
...
Recover the server from the cloud backup to the physical or virtual machine on your local site. For more information, see "Recovering a machine" in the Cyber Protection User Guide.
