...
Implementing disaster recovery > Disaster Recovery to Microsoft Azure > Connectivity and networks in Microsoft Azure > Adding a test recovery network from Microsoft Azure
Adding a test recovery network from Microsoft Azure
...
In the Test networks pane, click Add network.

In the Add test network window, in the Virtual network field, select a virtual network.
