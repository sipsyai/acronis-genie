...
Implementing disaster recovery > Disaster Recovery to Microsoft Azure > Failback in Microsoft Azure > Performing agentless failback via a hypervisor agent from Microsoft Azure
Performing agentless failback via a hypervisor agent from Microsoft Azure
...
You can install several agents on VMware ESXi hosts, and start a separate failback process using each of them. These failback processes can be performed at the same time.
