...
Implementing disaster recovery > Disaster Recovery to Cyber Protect Cloud > Connectivity and networks > Downloading the logs of the VPN gateway
Downloading the logs of the VPN gateway
...
On the Connectivity page, click the gear icon next to the VPN gateway.
Click the Download log.
[Optional] Select Capture network packets, and then configure the settings. For more information, see Capturing network packets.
Click Done.
