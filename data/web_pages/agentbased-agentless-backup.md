...
Installing and deploying Cyber Protection agents > Before you start > Agent-based and agentless backup
Agent-based and agentless backup

Agent-based backup requires that a protection agent is installed on each protected machine. Agent-based backup is supported on all physical and virtual machines. For more information about which agent you need and where to install it, see Which agent do I need?
...
Additional protection functionality, such as antivirus and antimalware, patch management, or remote desktop connection. For more information about these features, see Supported protection features by operating system.
...
Specific backup setups, such as LAN-free backup. For more information about this feature, see Agent for VMware - LAN-free backup.
