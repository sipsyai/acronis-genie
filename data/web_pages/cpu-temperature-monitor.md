...
RMM > Monitoring the health and performance of workloads > Configurable monitors > Settings of the CPU temperature monitor
Settings of the CPU temperature monitor
...
CPU temperature has exceeded (C°)



The maximum value of the monitored metric. If the value is exceeded, the system generates an alert.
