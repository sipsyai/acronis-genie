...
Managing the backup and recovery of workloads and files > Email archiving > Search queries > Searching for emails
Searching for emails

You can search for specific emails by using full-text search queries at the following levels:
