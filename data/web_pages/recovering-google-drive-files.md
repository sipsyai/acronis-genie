...
Managing the backup and recovery of workloads and files > Protecting Google Workspace data > Protecting Google Drive files > Recovering Google Drive files
Recovering Google Drive files
...
Expand the Users node, select All users, select the user whose Google Drive files you want to recover, and then click Recovery.
...
In Path, view or change the target folder in the target user's Google Drive or in the target Shared drive. By default, the original location is selected.
