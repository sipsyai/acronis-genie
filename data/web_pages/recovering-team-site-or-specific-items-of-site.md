...
Managing the backup and recovery of workloads and files > Protecting Microsoft 365 data > Microsoft 365 Business – Backup > Recovering a team site or specific items of a site
Recovering a team site or specific items of a site
Click Microsoft 365.
...
Expand the Teams node, select All teams, select the team whose site you want to recover, and then click Recovery.

You can search teams by name. Wildcards are not supported.

Select a recovery point.
Click Recover > Team site.

Browse to the required item or use search to obtain the list of the required items.
